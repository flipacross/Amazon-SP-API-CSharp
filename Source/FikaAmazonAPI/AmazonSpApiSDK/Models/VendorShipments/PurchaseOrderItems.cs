...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorShipments
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseOrderItems :  IEquatable<PurchaseOrderItems>, IValidatableObject
    {
        /// <summary>
        ...
        public PurchaseOrderItems(string itemSequenceNumber = default(string), string buyerProductIdentifier = default(string), string vendorProductIdentifier = default(string), ItemQuantity shippedQuantity = default(ItemQuantity), Money maximumRetailPrice = default(Money))
        {
            ...
            {
                throw new InvalidDataException("itemSequenceNumber is a required property for PurchaseOrderItems and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("shippedQuantity is a required property for PurchaseOrderItems and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PurchaseOrderItems);
        }

        public bool Equals(PurchaseOrderItems input)
        {
            if (input == null)
                return false;
