...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorShipments
{
    ...
    public partial class CollectFreightPickupDetails :  IEquatable<CollectFreightPickupDetails>, IValidatableObject
    {
        ...
        public CollectFreightPickupDetails(string requestedPickUp = default(string), string scheduledPickUp = default(string), string carrierAssignmentDate = default(string))
        {
        ...
        public string RequestedPickUp { get; set; }
        ...
        public string CarrierAssignmentDate { get; set; }
