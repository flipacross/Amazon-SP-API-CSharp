...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorShipments
{
    ...
    public partial class Stop :  IEquatable<Stop>, IValidatableObject
    {
        ...
        public Stop(FunctionCodeEnum? functionCode = default(FunctionCodeEnum?), Location locationIdentification = default(Location), string arrivalTime = default(string), string departureTime = default(string))
        {
