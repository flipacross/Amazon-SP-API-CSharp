...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorShipments
{
    ...
    public partial class ImportDetails :  IEquatable<ImportDetails>, IValidatableObject
    {
        ...
        public ImportDetails(MethodOfPaymentEnum? methodOfPayment = default(MethodOfPaymentEnum?), string sealNumber = default(string), Route route = default(Route), string importContainers = default(string), Weight billableWeight = default(Weight), string estimatedShipByDate = default(string), HandlingInstructionsEnum? handlingInstructions = default(HandlingInstructionsEnum?))
        {
        ...
        public string EstimatedShipByDate { get; set; }
