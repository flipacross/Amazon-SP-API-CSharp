...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorShipments
{
    ...
    public partial class ShipmentConfirmation :  IEquatable<ShipmentConfirmation>, IValidatableObject
    {
        ...
        public ShipmentConfirmation(string shipmentIdentifier = default(string), ShipmentConfirmationTypeEnum? shipmentConfirmationType = default(ShipmentConfirmationTypeEnum?), ShipmentTypeEnum? shipmentType = default(ShipmentTypeEnum?), ShipmentStructureEnum? shipmentStructure = default(ShipmentStructureEnum?), TransportationDetailsForShipmentConfirmation transportationDetails = default(TransportationDetailsForShipmentConfirmation), string amazonReferenceNumber = default(string), string shipmentConfirmationDate = default(string), string shippedDate = default(string), string estimatedDeliveryDate = default(string), PartyIdentification sellingParty = default(PartyIdentification), PartyIdentification shipFromParty = default(PartyIdentification), PartyIdentification shipToParty = default(PartyIdentification), ShipmentMeasurements shipmentMeasurements = default(ShipmentMeasurements), ImportDetails importDetails = default(ImportDetails), List<Item> shippedItems = default(List<Item>), List<Carton> cartons = default(List<Carton>), List<Pallet> pallets = default(List<Pallet>))
        {
        ...
        public string ShipmentConfirmationDate { get; set; }
        ...
        public bool Equals(ShipmentConfirmation input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ShippedItems.Equals(input.ShippedItems))
                ) && 
                (
                    this.Cartons == input.Cartons ||
                    (this.Cartons != null &&
                    this.Cartons.Equals(input.Cartons))
                ) && 
                (
