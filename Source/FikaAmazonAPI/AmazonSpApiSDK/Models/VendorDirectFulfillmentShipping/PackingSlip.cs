...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentShipping
{
    ...
    public partial class PackingSlip :  IEquatable<PackingSlip>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="PackingSlip" /> class.
        /// </summary>
        /// <param name="purchaseOrderNumber">Purchase order number of the shipment that corresponds to the packing slip. (required)</param>
        ...
        /// </summary>
        /// <value>Purchase order number of the shipment that corresponds to the packing slip.</value>
