...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentShipping
{
    ...
    public partial class StatusUpdateDetails :  IEquatable<StatusUpdateDetails>, IValidatableObject
    {
        ...
        /// <param name="shipmentSchedule">Details for the scheduled delivery timeline for a shipment, including the estimated delivery date and time, as well as the start and end times of the appointment window for delivery.</param>
        public StatusUpdateDetails(string trackingNumber = default(string), string statusCode = default(string), string reasonCode = default(string), string statusDateTime = default(string), Address statusLocationAddress = default(Address), object shipmentSchedule = default(object))
        {
        ...
        /// </summary>
        /// <value>Details for the scheduled delivery timeline for a shipment, including the estimated delivery date and time, as well as the start and end times of the appointment window for delivery.</value>
        [DataMember(Name="shipmentSchedule", EmitDefaultValue=false)]
        public object ShipmentSchedule { get; set; }
