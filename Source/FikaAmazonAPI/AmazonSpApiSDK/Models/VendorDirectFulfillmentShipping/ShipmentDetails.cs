...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentShipping
{
    ...
    public partial class ShipmentDetails :  IEquatable<ShipmentDetails>, IValidatableObject
    {
        ...
        public ShipmentDetails(string shippedDate = default(string), ShipmentStatusEnum? shipmentStatus = default(ShipmentStatusEnum?), bool? isPriorityShipment = default(bool?), string vendorOrderNumber = default(string), string estimatedDeliveryDate = default(string))
        {
