...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorInvoices
{
    ...
    public partial class CreditNoteDetails :  IEquatable<CreditNoteDetails>, IValidatableObject
    {
        ...
        public CreditNoteDetails(string referenceInvoiceNumber = default(string), string debitNoteNumber = default(string), string returnsReferenceNumber = default(string), string goodsReturnDate = default(string), string rmaId = default(string), string coopReferenceNumber = default(string), string consignorsReferenceNumber = default(string))
        {
        ...
        public string GoodsReturnDate { get; set; }
