...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorInvoices
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        public Invoice(InvoiceTypeEnum? invoiceType = default(InvoiceTypeEnum?), string id = default(string), string referenceNumber = default(string), string date = default(string), PartyIdentification remitToParty = default(PartyIdentification), PartyIdentification shipToParty = default(PartyIdentification), PartyIdentification shipFromParty = default(PartyIdentification), PartyIdentification billToParty = default(PartyIdentification), PaymentTerms paymentTerms = default(PaymentTerms), Money invoiceTotal = default(Money), List<TaxDetails> taxDetails = default(List<TaxDetails>), List<AdditionalDetails> additionalDetails = default(List<AdditionalDetails>), List<ChargeDetails> chargeDetails = default(List<ChargeDetails>), List<AllowanceDetails> allowanceDetails = default(List<AllowanceDetails>), List<InvoiceItem> items = default(List<InvoiceItem>))
        {
        ...
        public bool Equals(Invoice input)
        {
            ...
            return 
                ...
                (
                    ...
                    this.ChargeDetails.Equals(input.ChargeDetails))
                ) && 
                (
                    this.AllowanceDetails == input.AllowanceDetails ||
                    (this.AllowanceDetails != null &&
                    this.AllowanceDetails.Equals(input.AllowanceDetails))
                ) && 
                (
