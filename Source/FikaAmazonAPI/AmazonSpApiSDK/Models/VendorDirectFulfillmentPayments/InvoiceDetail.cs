...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.VendorDirectFulfillmentPayments
{
    ...
    public partial class InvoiceDetail :  IEquatable<InvoiceDetail>, IValidatableObject
    {
        ...
        public InvoiceDetail(string invoiceNumber = default(string), string invoiceDate = default(string), string referenceNumber = default(string), PartyIdentification remitToParty = default(PartyIdentification), PartyIdentification shipFromParty = default(PartyIdentification), PartyIdentification billToParty = default(PartyIdentification), string shipToCountryCode = default(string), string paymentTermsCode = default(string), Money invoiceTotal = default(Money), List<TaxDetail> taxTotals = default(List<TaxDetail>), List<AdditionalDetails> additionalDetails = default(List<AdditionalDetails>), List<ChargeDetails> chargeDetails = default(List<ChargeDetails>), List<InvoiceItem> items = default(List<InvoiceItem>))
        {
        ...
        public bool Equals(InvoiceDetail input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.TaxTotals != null &&
                    this.TaxTotals.Equals(input.TaxTotals))
                ) && 
                (
