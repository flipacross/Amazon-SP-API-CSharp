...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class Package :  IEquatable<Package>, IValidatableObject
    {
        ...
        public Package(string id = default(string), PackageDimensions dimensions = default(PackageDimensions), Weight weight = default(Weight), List<string> hazmatLabels = default(List<string>), PackageLineItems packageLineItems = default(PackageLineItems), StatusEnum? status = default(StatusEnum?), PackageHandlingRequirementsEnum? packageHandlingRequirements = default(PackageHandlingRequirementsEnum?))
        {
