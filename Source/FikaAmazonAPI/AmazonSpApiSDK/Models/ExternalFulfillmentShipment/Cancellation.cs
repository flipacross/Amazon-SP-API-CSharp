...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class Cancellation :  IEquatable<Cancellation>, IValidatableObject
    {
        ...
        public Cancellation(int? cancelledQuantity = default(int?), DateTime? cancelledTimestamp = default(DateTime?), CancellationTypeEnum cancellationType = default(CancellationTypeEnum), string cancellationReason = default(string))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CancelledQuantity, must be a value greater than or equal to 1.", new [] { "CancelledQuantity" });
            }
