...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class Shipment :  IEquatable<Shipment>, IValidatableObject
    {
        ...
        public Shipment(string id = default(string), string locationId = default(string), MarketplaceAttributes marketplaceAttributes = default(MarketplaceAttributes), ShipmentInfo shipmentInfo = default(ShipmentInfo), InvoiceInfo invoiceInfo = default(InvoiceInfo), PartyIdentificationInfoList partyInfoList = default(PartyIdentificationInfoList), ShipmentRequirements shipmentRequirements = default(ShipmentRequirements), Charges charges = default(Charges), StatusEnum status = default(StatusEnum), SubStatusEnum? subStatus = default(SubStatusEnum?), string reason = default(string), List<ShipmentLineItem> lineItems = default(List<ShipmentLineItem>), ShippingInfo shippingInfo = default(ShippingInfo), List<Package> packages = default(List<Package>), DateTime? creationDateTime = default(DateTime?), DateTime? lastUpdatedDateTime = default(DateTime?), DateTime? earliestPackDateTime = default(DateTime?))
        {
