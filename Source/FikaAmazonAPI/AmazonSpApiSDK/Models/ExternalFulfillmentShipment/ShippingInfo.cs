...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class ShippingInfo :  IEquatable<ShippingInfo>, IValidatableObject
    {
        ...
        public ShippingInfo(string recommendedShipMethod = default(string), DateTime? expectedShippingDateTimeInUTC = default(DateTime?), Address shipToAddress = default(Address), ShippingTypeEnum? shippingType = default(ShippingTypeEnum?), RecommendedPackages recommendedPackages = default(RecommendedPackages))
        {
