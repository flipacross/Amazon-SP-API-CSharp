...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        /// <param name="geocodes">The geographic coordinates of the address..</param>
        ...
        /// </summary>
        /// <value>The geographic coordinates of the address.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AddressType, length must be less than 20.", new [] { "AddressType" });
            }

            // AddressType (string) minLength
            if(this.AddressType != null && this.AddressType.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AddressType, length must be greater than 1.", new [] { "AddressType" });
            }
