...
namespace FikaAmazonAPI.AmazonSpApiSDK.Models.ExternalFulfillmentShipment
{
    ...
    public partial class MarketplaceAttributes :  IEquatable<MarketplaceAttributes>, IValidatableObject
    {
        ...
        public MarketplaceAttributes(string marketplaceId = default(string), string channelName = default(string), string merchantId = default(string), CustomChannelAttribute customAttributes = default(CustomChannelAttribute))
        {
